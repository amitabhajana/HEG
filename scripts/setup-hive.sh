...
function installESJAR {
	curl -o elasticsearch-hadoop-7.14.1.zip  https://artifacts.elastic.co/downloads/elasticsearch-hadoop/elasticsearch-hadoop-7.14.1.zip
	unzip elasticsearch-hadoop-7.14.1.zip
	cp elasticsearch-hadoop-7.14.1/dist/elasticsearch-hadoop-hive-7.14.1.jar /usr/local/hive/lib
}
